...
public class AnGiFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mode == 1)
            odauController.getDanhSachQuanAnGanNhatController(getContext(),nestedScrollView,recyclerAnGi,progressBar,vitrihientai);
        else if (mode == 2)
            odauController.getDanhSachQuanAnCoGiaoHangController(getContext(),nestedScrollView,recyclerAnGi,progressBar,vitrihientai);
        else if (mode == 3)
            odauController.getDanhSachQuanAnController(getContext(),nestedScrollView,recyclerAnGi,progressBar,vitrihientai);
        else
            odauController.getDanhSachQuanAnTheoDiemDanhGiaController(getContext(),nestedScrollView,recyclerAnGi,progressBar,vitrihientai);
